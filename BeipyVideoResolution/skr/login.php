...
if($_POST['username'] && $_POST['password']){
	...
	$admin_pass = htmlspecialchars($_POST['password']);
...
<tr class="header">
			<td colspan="4" align="center" style=" height:50px; font-size:18px; font-weight:bold;    background-color: #ecf1fc;">影院系统登陆</td>
</tr>
